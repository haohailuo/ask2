...
$lang = array(
	...
	'db_not_null' => '数据库中已经安装过 ask, 继续安装会清空原有数据。',
	...
	'step_post_siteinfo_title' => '提交站点资料',
	'step_post_siteinfo_desc' => '填写站点资料，以便我们能及时提供给您产品新版本信息和相关技术支持',
	...
	'tips_admininfo_comment' => '请牢记ask2问答系统创始人密码，凭该密码登陆 ask。',
	'step_ext_info_title' => '安装成功',
	'step_ext_info_desc' => '点击进入登陆',

	'ext_info_succ' => '安装成功',
	'install_locked' => '安装锁定，已经安装过了，如果您确定要重新安装，请到服务器上删除<br /> '.str_replace(ASK2_ROOT, '', $lockfile),
	'error_quit_msg' => '您必须解决以上问题，安装才可以继续',

	'step_app_reg_title' => '设置运行环境',
	'step_app_reg_desc' => '检测服务器环境以及设置 ask',
	'tips_ask' => '请填写ask2问答系统相关信息',
	'tips_ask_comment' => 'ask 是 Comsenz 公司产品的核心服务程序，Discuz! Board 的安装和运行依赖此程序。如果您已经安装了 ask，请填写以下信息。否则，请到 <a href="http://www.ask2.cn/" target="blank">Comsenz 产品中心</a> 下载并且安装，然后再继续。',
	...
	'tablepre_comment' => '同一数据库运行多个问答系统时，请修改前缀',
	'forceinstall_check_label' => '我要删除数据，强制安装 !!!',

	'uc_url_empty' => '您没有填写ask2问答系统的 URL，请返回填写',
	'uc_url_invalid' => 'URL 格式错误',
	'uc_url_unreachable' => 'ask 的 URL 地址可能填写错误，请检查',
	'uc_ip_invalid' => '无法解析该域名，请填写站点的 IP</font>',
	'uc_admin_invalid' => 'UC创始人密码错误，请重新填写',
	'uc_data_invalid' => '通信失败，请检查 UC的URL 地址是否正确 ',
	'ask_ucurl_invalid' => 'UC的URL为空，或者格式错误，请检查',
	'ask_ucpw_invalid' => 'UC的创始人密码为空，或者格式错误，请检查',
	...
	'admininfo_ucadminname_invalid' => '创始者用户名不能为空',
	'admininfo_ucadminemail_invalid' => '邮箱地址不合法',
	...
	'uc_version_incorrect' => '您的ask2问答系统服务端版本过低，请升级ask2问答系统服务端到最新版本，并且升级，下载地址：http://www.ask2.cn/ 。',
	'config_unwriteable' => '安装向导无法写入配置文件, 请设置 config.inc.php 程序属性为可写状态(777)',

	'install_in_processed' => '正在安装...',
	'install_succeed' => '安装ask2成功，点击进入下一步',
	'license' => '<div class="license"><h1>中文版授权协议 适用于中文用户</h1>

<p>版权所有 (c) 2001-2012，ask2软件开发工作室保留所有权利。</p>

<p>感谢您选择ask2问答产品。希望我们的努力能为您提供一个高效快速和强大的站点解决方案。</p>

<p>ask2软件开发工作室为ask2问答产品的开发商，依法独立拥有ask2问答系统著作权。ask2软件开发工作室网址为 http://www.ask2.cn</p>

<p>ask2问答系统著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用ask2问答系统软件。</p>

<p>本授权协议适用且仅适用于ask2 3.X版本，ask2软件开发工作室拥有对本授权协议的最终解释权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
<li>您可以在协议规定的约束和限制范围内修改ask2问答系统源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.ask2.cn参考相关说明，也可以致电15911179271了解详情。</li>
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用ask2答系统的整体或任何部分，未经书面许可，页面页脚处的ask2问答系统名称和ask2软件开发工作室下属网站（http://www.ask2.cn ） 的链接都必须保留，而不能清除或修改。</li>
<li>禁止在ask2问答系统的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
<li>ask2软件开发工作室不对使用本软件构建的网站中的文章或信息承担责任。</li>
</ol>

<p>有关ask2问答系统最终用户授权协议、商业授权与技术服务的详细内容，均由ask2问答系统官方网站独家提供。ask2软件开发工作室拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 ask，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p></div>',

	'uc_installed' => '您已经安装过 ask，如果需要重新安装，请删除 data/install.lock 文件',
	'i_agree' => '我已仔细阅读，并同意上述条款中的所有内容',
	'supportted' => '支持',
	'unsupportted' => '不支持',
	'max_size' => '支持/最大尺寸',
	'project' => '项目',
	'ask_required' => 'ask 所需配置',
	'ask_best' => 'ask 最佳',
	'curr_server' => '当前服务器',
	'env_check' => '环境检查',
	'os' => '操作系统',
