...
class base {
    ...
    function checkable($url) {
        ...
        if (1 == $this->user['groupid'])
            return true;
        $regulars = explode(',', 'tags/default,new/maketag,tag/default,user/regtip,new/default,user/addxinzhi,topic/userxinzhi,topic/getone,user/login,user/logout,user/code,user/getpass,user/resetpass,index/help,js/view,attach/upload,' . $this->user['regulars']);
